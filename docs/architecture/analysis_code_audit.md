...
| `scripts/analysis/generate_reports.py` | Thin wrapper for canonical validation reports. | Active validation utility. | Validation metrics. | Validation reports. | Valid for validation, not pre-modelling analysis. | `scripts/analysis/generate_analysis_report.py` for pre-modelling reporting. | KEEP |

...
DEFAULT_ANALYSIS_CONFIG: dict[str, Any] = {
    ...
    "pitch_visualisation": {"pitch_type": "statsbomb", "orientation": "horizontal", "density_bins": [12, 8], "coarse_bins": [6, 4], "positional_bins": True, "kde_levels": 20},
    "minimum_spatial_bin_actions": 20,
    "clustering_spatial_feature_mode": "reduced",

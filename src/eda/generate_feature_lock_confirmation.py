...
CHANGES_SINCE_LAST_FULL_RUN = [
    {
        "change": "defender_functional_role bucket fix (prompt 8)",
    ...
    {
        "change": "V2 methodology-gap fixes (prompt 7)",
    ...
    {
        "change": "VIF drop (prompt 9 Part B)",
    ...
    {
        "change": "Leakage drop (prompt 10 Part C)",
    ...
    {
        "change": "Football sanity check (prompt 11)",
    ...
    {
        "change": "Passive archetype clustering (prompt 12)",
    ...
    {
        "change": "Canonical match-grouped split (prompt 13)",
